...
const SkullIcon = ({ className }) => (
    <svg viewBox="0 0 36 36" xmlns="http://www.w3.org/2000/svg" className={className} preserveAspectRatio="xMidYMid meet">
        <g>
            ...
            <circle fill="#111827" cx="11" cy="14" r="5"></circle>
            <circle fill="#111827" cx="25" cy="14" r="5"></circle>
            <path fill="#111827" d="M19.903 23.062C19.651 22.449 18.9 22 18 22s-1.652.449-1.903 1.062A1.494 1.494 0 0 0 15 24.5a1.5 1.5 0 0 0 1.5 1.5c.655 0 1.206-.422 1.41-1.007c.03.001.059.007.09.007s.06-.006.09-.007a1.496 1.496 0 1 0 1.813-1.931z"></path>
        </g>
    </svg>
);
